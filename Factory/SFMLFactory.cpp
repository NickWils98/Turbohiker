...
std::shared_ptr<Hiker> SFMLFactory::createHiker(std::tuple<double, double> size, std::tuple<double, double> position) {
    ...
    std::shared_ptr<Hiker> player = std::make_shared<HikerSFML>(HikerSFML(window, tex, sfmlsize, sfmlposition));
