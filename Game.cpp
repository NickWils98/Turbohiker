...
//    make a speech bubble factory for the hikers sow they can yell
    ...
    std::vector<std::shared_ptr<HikerFactory>> hikers;
...
//    layout factory
    std::vector<std::shared_ptr<LayoutFactory>> layout;
    std::shared_ptr<LayoutFactory> laneLine = std::make_shared<LineFactory>(
            LineFactory(window, sf::Color::White, view, true));
    std::shared_ptr<LayoutFactory> endlLine = std::make_shared<LineFactory>(
            LineFactory(window, sf::Color::White, view, false));
    std::shared_ptr<LayoutFactory> liveScore = std::make_shared<ScoreFactory>(window, sf::Color::White, view,
                                                                              "Score:\n", f, true);
    std::shared_ptr<LayoutFactory> highScore = std::make_shared<ScoreFactory>(window, sf::Color::White, view,
...
void Game::initObstacles() {
    ...
    std::shared_ptr<HikerFactory> rat = std::make_shared<VerminFactory>(window, ratTexture, view);
